...
namespace RealEstate_Dapper_Api.Controllers
{
    ...
    public class WhoWeAreDetailController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateWhoWeAreDetail(CreateWhoWeAreDetailDto createWhoWeAreDetailDto)
        {
            ...
            return Ok("Hakimizda kismi basarli bir sekilde eklendi");
        }
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteWhoWeAreDetail(int id)
        {
           _whoWeAreDetailRepository.DeleteWhoWeAreDetail(id);
            return Ok("Hakimizda kismi basarli bir sekilde silindi");
        }
        [HttpPut]
        public async Task<IActionResult> UpdateWhoWeAreDetail(UpdateWhoWeAreDetailDto updateWhoWeAreDetailDto)
        {
            _whoWeAreDetailRepository.UpdateWhoWeAreDetail(updateWhoWeAreDetailDto);
            return Ok("Hakimizda kismi basarli bir sekilde guncelendi");
        }
        [HttpGet("{id}")]
