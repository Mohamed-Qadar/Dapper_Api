...
namespace RealEstate_Dapper_Api.Controllers
{
    ...
    public class BottomGridsController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateBottomGrid(CreateBottomGridDto createBottomGridDto)
        {
            ...
            return Ok("veri kismi basarli bir sekilde eklendi");
        }
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteBottomGrid(int id)
        {
            _bottomGridRepository.DeleteBottomGrid(id);
            return Ok("veri basarli bir sekilde silindi");
        }
        [HttpPut]
        public async Task<IActionResult> UpdateBottomGrid(UpdataBottomGridDto updateBottomGridDto)
        {
            _bottomGridRepository.UpdateBottomGrid(updateBottomGridDto);
            return Ok("veri  basarli bir sekilde guncelendi");
        }
        [HttpGet("{id}")]
